...
function displayMemberHeader() {
	...
	$("header").html(
		...
		`<div id="logInBoxes">
			<nav>
				<a class="btn" id="myAccountNavButton" href="myAccount">My Account</a>
		...
		<div id="navChoices">
			<nav>
				<a class="btn" id="homeNavButton" href="home">home</a>
				<a class="btn" id="listenNavButton" href="listen">listen</a>
				<a class="btn" id="blogNavButton" href="blog">blog</a>
				<a class="btn" id="aboutNavButton" href="about">about</a>
				<a class="btn" id="contactNavButton" href="contact">contact</a>
			</nav>
		</div>`
...
function displayAdminHeader() {
	...
	$("header").html(
		...
		`<div id="logInBoxes">
			...
			<nav>
				<a class="btn" id="TSPadminNavButton" href="TSPadmin">Admin Portal</a>
				<a class="btn" id="myAccountNavButton" href="myAccount">My Account</a>
				<a class="btn" id="logOutNavButton" onClick="logOutFromWebsite()">Log Out</a>
			</nav>
		</div>
...
function displayUserHeader() {
	...
	$("header").html(
		...
		`<div id="logInBoxes">
			<nav>
				<a class="btn" id="logInNavButton" href="logIn">Log In</a>
				<a class="btn" id="signUpNavButton" href="signUp">Sign Up</a>
			</nav>
		</div>
		<div id="TspLogo">
			<a href="home">
