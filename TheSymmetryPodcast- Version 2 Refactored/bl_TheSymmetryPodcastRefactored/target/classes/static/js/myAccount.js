...
function deleteAccount() {
	...
	$.ajax({
		...
		success: function() {
			...
			alert("We're sorry to see you go.  Your account has been successfully deleted.");
...
function changePasswordFieldsFromEditToSave() {
	$("#passwordDisplay").html(	
		`<input type="password" class="text full-width inputBox" placeholder="Password" id="passwordInput" maxlength="20">`	
	);
