...
public class ContactMessageRepositoryTest {
    ...
    @Test
    public void testFindByStatus1_1() {
        ContactMessage message1 = createMessage(1);
        contactRepo.save(message1);
        
        List<ContactMessage> listOfMessages = contactRepo.findByStatus1();
        
        assertTrue(listOfMessages.contains(message1));
    }
    
    @Test
    public void testFindByStatus1_2() {
    ...
    @Test
    public void testFindByStatus1_3() {
        ContactMessage message1 = createMessage(1);
        contactRepo.save(message1);
    ...
    @Test
    public void testFindByStatus2_1() {
        ContactMessage message1 = createMessage(2);
        contactRepo.save(message1);
        
        List<ContactMessage> listOfMessages = contactRepo.findByStatus2();
        
        assertTrue(listOfMessages.contains(message1));
    }
    
    @Test
    public void testFindByStatus2_2() {
        ContactMessage message1 = createMessage(1);
        contactRepo.save(message1);
    ...
    @Test
    public void testFindByStatus2_3() {
        ContactMessage message1 = createMessage(1);
        contactRepo.save(message1);
    ...
    @Test
    public void testFindByStatus3_1() {
        ContactMessage message1 = createMessage(3);
        contactRepo.save(message1);
        
        List<ContactMessage> listOfMessages = contactRepo.findByStatus3();
        
        assertTrue(listOfMessages.contains(message1));
    }
    
    @Test
    public void testFindByStatus3_2() {
        ContactMessage message1 = createMessage(1);
        contactRepo.save(message1);
    ...
    @Test
    public void testFindByStatus3_3() {
        ContactMessage message1 = createMessage(3);
        contactRepo.save(message1);
